...
func runApp(args []string) error {
	...
	defaultFileTypes := []string{"txt", "text", "md", "markdown", "rtf", "csv", "pdf", "json", "ipynb", "notebook", "html", "xml", "musicxml", "log", "cfg", "ini", "docx", "xlsx", "pptx", "office", "eml", "email", "image", "media"}
